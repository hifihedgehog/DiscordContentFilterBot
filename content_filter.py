    ...
    if len(recent_violations) >= server_config["punishments"]["max_violations"]:
        ...
        if role_id:
            ...
            if role:
                ...
                embed_punish_2.add_field(name="Duration", value=punishment_duration_str, inline=False)
                ...
                if log_channel_id:
                    ...
                    if log_channel:
                        ...
                        embed_log.add_field(name="Duration", value=punishment_duration_str, inline=False)
...
async def view_configuration(interaction: discord.Interaction):
    ...
    for category_id in global_exceptions.get("categories", []):
        category = interaction.guild.get_channel_or_thread(category_id)
        if category:
